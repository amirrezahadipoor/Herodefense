...
public final class GameOverOverlayRenderer implements AutoCloseable {
    ...
    private void drawEpilogue(
        ...
        // The Hollow's word on this death is no longer a line of the panel: it speaks in the message box
        // before the reveal (FrameDriver), in the Hollow's voice, and the box marks it shown when it closes.
