...
public final class LoreCatalog {
    ...
    private static final List<LoreEntry> ALL = List.copyOf(Arrays.asList(
            ...
            entry(35, "The Hill's Armour", "زرهٔ تپه",
                "It does not dodge and it does not flinch. It simply decides to be stone for a while, and stone does not care how hard you are trying.",
                "نه جا خالی می‌کند نه پلک می‌زند. فقط تصمیم می‌گیرد مدتی سنگ باشد، و سنگ کاری ندارد چقدر تلاش می‌کنی.",
                LoreTrigger.ELITE_KILL, "stoneshell"),
            entry(36, "What the Ground Kept", "آن‌چه زمین نگه داشت",
                "Everything that dies here leaves something in the soil. Most of it is quiet. Some of it is still angry where it stood, and it stays angry for a while.",
                "هرچه اینجا می‌میرد چیزی در خاک جا می‌گذارد. بیشترش ساکت است. بعضی‌اش هنوز همان‌جا خشمگین است، و مدتی خشمگین می‌ماند.",
                LoreTrigger.ELITE_KILL, "gravebloom"),
            entry(37, "Replacements", "جانشین‌ها",
                "I used to think killing it was the end of it. It calls for more. It always had more. That is the part of this night I never learned how to count.",
                "قبلاً فکر می‌کردم کشتنش پایانش است. صدا می‌زند. همیشه بیشتر داشته. همین بخشِ این شب است که هرگز یاد نگرفتم چطور بشمارم.",
                LoreTrigger.ELITE_KILL, "swarmcall"),
            entry(38, "A Promise at Arm's Length", "وعده‌ای به‌اندازهٔ یک قدم",
                "It wears its reach like a warning. Stand close and it keeps its word; stand far and the word means nothing. That is the fairest thing in the grove.",
                "دسترسش را مثل هشدار می‌پوشد. نزدیک بایست و به قولش عمل می‌کند؛ دور بایست و آن قول هیچ معنایی ندارد. این عادلانه‌ترین چیزِ بیشه است.",
                LoreTrigger.ELITE_KILL, "spitebarb"),
            entry(39, "The Ground Says Where", "زمین می‌گوید کجا",
                "It raises one arm and the ground goes dark in a circle. You have that long to be somewhere else. I have never seen anyone learn this faster than one night.",
                "یک دستش را بالا می‌برد و زمین در یک دایره تاریک می‌شود. تا آن‌وقت فرصت داری جای دیگری باشی. ندیده‌ام کسی این را سریع‌تر از یک شب یاد بگیرد.",
                LoreTrigger.ELITE_KILL, "hammerfall"),
            entry(40, "The One Holding the Leash", "آن‌که بند را در دست دارد",
                "Hear the howl and you have found the one that decides how fast the line walks. Kill it and the whole wave remembers how tired it was.",
                "زوزه را بشنو و آن‌که تصمیم می‌گیرد صف چقدر تند راه برود را یافته‌ای. بکشش و تمام موج یادش می‌آید چقدر خسته بوده.",
                LoreTrigger.ELITE_KILL, "bloodhowl"),
            entry(41, "Nothing Is Left Empty", "هیچ‌جا خالی نمی‌ماند",
                "I said it once and I will say it a different way: the Hollow does not leave a place unattended. Kill the loud one and something quieter is already standing in its spot.",
                "یک بار گفتم و این بار جور دیگری می‌گویم: حُفره هیچ جایی را بی‌نگهبان نمی‌گذارد. صدای بلند را بکش و چیزی آهسته‌تر همان‌جا ایستاده است.",
                LoreTrigger.ELITE_KILL, "hollowmolt"),
            entry(42, "Patience With a Root", "صبوری با یک ریشه",
                "It heals the way a root drinks: slowly, without hurry, and in the wrong direction. Wounds here do not close. They simply get covered.",
                "مثل ریشه‌ای که آب می‌خورد التیام می‌یابد: آهسته، بی‌عجله، و در جهت اشتباه. زخم‌های اینجا بسته نمی‌شوند. فقط پوشیده می‌شوند.",
                LoreTrigger.ELITE_KILL, "gravemoss"),
