...
that unmaking's name — and the eight bosses are its eight ways of touching the world: through stone
(Ancient Golem), through root and thorn (Thorn Matriarch), through fire (Ember Wyrm), through
the shadow it left behind it when it fell (Void Knight), through frost (Frost Titan), through
lingering memory (Shadow Lich), through storm (Storm Colossus), and through the Tree's own wound
(Bloodroot Avatar). The World Tree is the one root the Hollow
...
- **Storm Colossus**, first meeting: *"STORM COLOSSUS — thunder in a stone chest."*
- **Bloodroot Avatar**, first meeting: *"BLOODROOT AVATAR — the grove's own wound."*
...
13. **"Winter That Walks."** *"The frost came after the Hollow fell, not before. It kept what it touched. The Titan is what kept walking after everything else froze."*
14. **"The Second Fall."** *"It was not a boss before. It was a record keeper. Now it keeps the record of how many times the grove has fallen and how."*
15. **"Thunder in Stone."** *"Stone that learned to hold thunder instead of moss. It does not hurry. Thunder never does."*
16. **"The Grove's Wound."** *"The World Tree's own root, taken and twisted. It bleeds sap that never dries. The Tree knows its shape."*

### 5.3 Elite-kill entries (unlock on first kill of an Elite carrying that affix)

17. **"On Letting Go."** *(Blightburst fragment, restated for the Codex list)* *"Some of them
    stop fighting you and start fighting the thing inside them instead. That one usually loses
    both battles at once."*
18. **"A Root's Last Job."** *(Rootward Ward)* *"I do not control what the Hollow does with what
...
19. **"The Trail Home."** *(Weeping Rot)* *"Every rotting thing wants to return to soil eventually. I only wish this kind of soil grew a thing other than more of itself."*

### 5.4 Ascension entries (unlock on completing that Ascension tier)

20. **After Ascension 1 — "Again."** *"You came back. I did not expect that. I am not certain the Hollow expected it either. Which may be the only advantage either of us has left."*
21. **After Ascension 2 — "The Shape of a Habit."** *"Twice now. I am beginning to recognize your footsteps before I see you. That is not nothing, after this many years of forgetting faces."*
22. **After Ascension 3 — "What Doesn't Reset."** *"The waves start over. The dark starts over. You do not. Not all the way. I have watched enough Wardens to know the difference between someone starting fresh and someone simply starting again."*
23. **After Ascension 5 — "A Question I Don't Ask Often."** *"I wonder, sometimes, if the Hollow
    gets tired the way you do. I have decided I do not want to know the answer badly enough to ask
    it."*
24. **After Ascension 10 — "The Long Vigil."** *"I have had guardians who lasted a season and
...
25. **"Bare-Handed"** *(reach Wave 50 having bought no Shop stats this run)* — *"You did that with what you were given, not with what you bought. I do not know whether to call that discipline or stubbornness. Possibly they are the same root."*
26. **"A Full Set"** *(equip a complete 4-piece set for the first time)* — *"Matched things hold
    together better than mismatched ones. I could have told you that before you spent the coin
    learning it."*
27. **"Mastery, Spent"** *(any skill reaches level 10 for the first time)* — *"You have done that thing ten times so precisely that it no longer looks like effort. I recall when standing here felt like that too."*
28. **"Reforged"** *(forge any item to its maximum Anvil level for the first time)* — *"Nothing
    stays as it was made. You, least of all. I mean that kindly."*
29. **"Six Mythics"** *(own all six Mythic items at once, any slot combination)* — *"I did not
    think there were six things left in this whole grove worth calling unique. I am glad to be
    wrong."*
30. **"No Potions Spent"** *(clear an entire Wave 1–100 stretch without consuming a single potion)*
...
31. **"The Long Pause"** *(pause the game mid-wave for an unusually long time, then resume)* —
...
32. **"Every Elite, Once"** *(kill at least one Elite of every affix type)* — *"You have heard every fragment I have to whisper through them now. There is more to tell. There is always more. It simply is not theirs to carry."*
33. **"Fastest Fall"** *(clear a single wave in record time, e.g. under a defined threshold)* —
    *"That was over before the Hollow finished sending it. I do not think it noticed yet."*
34. **"Two Hundred, Once More"** *(reach Wave 200 for the second time, any Ascension tier)* —
