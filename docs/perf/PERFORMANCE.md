...
| `sheetsMeasured` | 111 | count | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `sheetsThatAreMasks` | 34 | count | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `sheetsClearingTheBar` | 16 | count | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `sheetsMeasuredForColour` | 111 | count | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `sheetsTheToolWouldShip` | 16 | count | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `bestColourPsnr` | 40.51 | dB | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `worstColourPsnr` | 25.09 | dB | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `medianColourPsnr` | 33.01 | dB | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `sheetsBeatingTheReference` | 111 | count | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
| `referenceMedianPsnr` | 32.28 | dB | `2026-09-17-texture-encoding-sweep` (2026-09-17) | `b8c7cd6` | `python3 tools/texture/encode_textures.py --keys <every sheet> --reference <google etc1 harness>` |
...
- `2026-09-17-texture-encoding-sweep` — 2026-09-17, `b8c7cd6`. the ETC2 encoder measured over every sheet in the catalog, with Google's etc1 encoder measured on the same pixels beside it; a sheet ships only if the alpha gate and the 32 dB bar both pass, and none does yet
